    ...
    render() {
        return (
            <nav className="nav">
                <ul>
                    <li>
                        <Link class='aaa' to="/"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="gb_Uc">
                            <path
                    ...
                    <li>
                        ...
                        </svg>Напоминания</Link>
                    </li>
                    <li>
                        <Link class='aaa' to="/buscketpage"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                                             className="gb_Uc">
                            <path
